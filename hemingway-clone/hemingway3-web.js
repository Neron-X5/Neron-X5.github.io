!(function(e) {
    ...
    function(e, t, n) {
        (function(e) {
            ...
            var r = n(1),
                ...
                h = t(p);
            (e.Draft = c.default),
                (e.hemingwayStore = (0, u.createStore)(h.default)),
                a.default.render(
                    ...
                    document.getElementById('hemingway')
                ),
    ...
    function(e, t, n) {
        ...
        function h(e, t) {
            if ('split-block' === e.getLastChangeType()) {
                var n = S(e),
                    ...
                    i = v.default.pipe(
                        v.default.invoker(0, 'getText'),
                        b.default.run,
                        v.default.prop('stats')
                    )(o);
                t(o.getKey(), i);
            }
        }
        Object.defineProperty(t, '__esModule', {
            ...
            (t.getText = t.createEmptyEditorState = t.createEditorState = void 0),
            (t.decreaseIndent = o),
            (t.handleKeyCommand = i),
            (t.handleTab = a),
            (t.isOnEmptyListItem = u),
            (t.overridePaste = s),
            (t.replaceString = l),
            (t.setSelection = c),
            (t.toggleBlockType = d),
            (t.toggleInlineStyle = f),
            (t.toggleLink = p),
            (t.trackLastBlockAfterSplit = h);
        var y = n(6),
            g = n(4),
            v = r(g),
            m = n(15),
            ...
            T = v.default.pipe(
                w,
                v.default.invoker(0, 'getFocusKey')
            ),
            S = v.default.invoker(0, 'getCurrentContent');
        (t.createEditorState = v.default.pipe(
            y.ContentState.createFromText,
            y.EditorState.createWithContent
        )),
            (t.createEmptyEditorState = y.EditorState.createEmpty),
            (t.getText = v.default.pipe(
                S,
                v.default.invoker(0, 'getPlainText')
            ));
    },
    function(e, t) {
        e.exports = Draft;
                    ...
                    u(t, [
                        {
                            ...
                            value: function() {
                                var e =
                                    'hemingway-richtext-style-button hemingway-richtext-' +
                                    this.props.styleName.toLowerCase();
                                return (
                                    this.props.active && (e += ' hemingway-richtext-active-button'),
    ...
    function(e, t, n) {
        ...
        var o = n(4),
            ...
            c = r(l),
            d = (0, o.pipe)(
                a.default.parse.bind(a.default),
                s.default.score.bind(s.default),
                c.default.highlight.bind(c.default)
            ),
            f = {
                run: d
            };
            ...
            s = {
                ...
                getReadabilityStyle: function(e) {
                    ...
                    return t < 14
                        ...
                        : n >= 14
                        ? i.default.readability.veryHard
                        : i.default.readability.normal;
                },
                ...
                scoreHighlightTotals: function(e) {
                    ...
                    e.stats.highlights = u.default.getSentences(e).reduce(function(e, n) {
                        ...
                        return (
                            (e.adverbs +=
                                t.countTokensOfType(r, i.default.tokens.adverb) +
                                t.countTokensOfType(r, i.default.tokens.qualifier) +
                                t.countTokensOfType(r, i.default.tokens.vaguePhrase)),
                            (e.passiveVoices += t.countTokensOfType(r, i.default.tokens.passiveVoice)),
                            (e.complexWords +=
                                t.countTokensOfType(r, i.default.tokens.complexWord) +
                                t.countTokensOfType(r, i.default.tokens.buzzword) +
                                t.countTokensOfType(r, i.default.tokens.cliche)),
        ...
        var u = (function() {
            ...
            h = (function(e) {
                function t(e) {
                    ...
                    var n = i(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e));
                    return (
                        (n.initialEditorState = (0, f.default)(n.props.trackBlock)),
                        (n.bindKeys = n.bindKeys.bind(n)),
                        (n.handleKeyCommand = n.handleKeyCommand.bind(n)),
                        (n.overridePastedText = n.overridePastedText.bind(n)),
                        (n.onTab = n.onTab.bind(n)),
                        (n.focusEditor = function() {
                ...
                return (
                    ...
                    u(t, [
                        ...
                        },
                        {
                            ...
                            value: function() {
                                (0, p.trackLastBlockAfterSplit)(this.props.editorState, this.props.trackBlock),
                                    this.props.showURLInput || this.focusEditor();
                            }
                        },
                        {
                            key: 'onTab',
                        ...
                        },
                        {
                            ...
                            value: function(e) {
                                var t = c.KeyBindingUtil.hasCommandModifier,
                                    n = t(e);
                                return 74 === e.keyCode && n
                                    ? 'write-edit'
                                    : 75 === e.keyCode && n
                                    ? 'show-url-input'
                                    : 13 === e.keyCode && (0, p.isOnEmptyListItem)(this.props.editorState)
                                    ? 'decrease-indent'
                                    : (0, c.getDefaultKeyBinding)(e);
                            }
                        },
                        {
                            ...
                            value: function(e) {
                                ...
                                return (
                                    !t &&
                                    ('write-edit' === e
                                        ? (this.props.toggleWriteEdit(), !0)
                                        : 'show-url-input' === e
                                        ? (this.props.turnOnURLInput(), !0)
                                        : 'decrease-indent' === e
                                        ? (this.props.decreaseIndent(this.props.editorState), !0)
                                        : ('bold' === e || 'italic' === e) &&
                                          (this.props.handleKeyCommand(this.props.editorState, e), !0))
                                );
                            }
                        },
                        {
        ...
        var u = (function() {
            ...
            m = function(e) {
                return l.default.createElement(
                    ...
                    l.default.createElement('em', null, e.name),
                    ': ',
                    l.default.createElement('strong', null, 'Reading time' === e.name ? v(e.value) : e.value)
                );
            },
                ...
                switch (e.name) {
                    case 'adverbs':
                        return (
                            ...
                            (0 === e.value
                                ? '. Well done.'
                                : (e.value <= r ? ', meeting the goal of ' : '. Aim for ') + (r + ' or fewer.'))
                        );
                    case 'passiveVoices':
                        return (
                            ' use' +
                            ...
                            (0 === e.value
                                ? '. Nice work.'
                                : (e.value <= o ? ', meeting the goal of ' : '. Cut to ') + (o + ' or fewer.'))
                        );
                    case 'complexWords':
                        return (
                            ' phrase' + (1 === e.value ? ' has a simpler alternative.' : 's have simpler alternatives.')
                        );
                    default:
                        return (
                            ' of ' +
            ...
            w = function(e, t) {
                ...
                return l.default.createElement(
                    'p',
                    null,
                    l.default.createElement('strong', null, '' + n),
                    r ? '. Aim for ' + r + '.' : null
                );
            },
            T = function(e, t, n) {
                return Object.keys(e)
                    ...
                    .map(function(e) {
                        var r = function(e) {
                            return 'hardSentences' === e
                                ? d.default.readability.hard.toLowerCase()
                                : 'veryHardSentences' === e
                                ? d.default.readability.veryHard.toLowerCase()
                                : e.substr(0, e.length - 1).toLowerCase();
                        };
                        return l.default.createElement(
                            'div',
                            {
            ...
            S = (function(e) {
                function t(e) {
                    ...
                    var n = i(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e));
                    return (
                        (n.toggleShowMore = n.toggleShowMore.bind(n)),
                        (n.state = {
                            showAllStats: !1
                        }),
                        n
        ...
        var u = (function() {
            ...
            p = (function(e) {
                function t(e) {
                    ...
                    return (
                        (n.state = f),
                        (n.onToggle = n.onToggle.bind(n)),
                        (n.onChange = n.onChange.bind(n)),
                        (n.onKeyUp = n.onKeyUp.bind(n)),
                        (n.saveUrl = n.saveUrl.bind(n)),
                        (n.cancel = n.cancel.bind(n)),
                        n
                    );
                }
                return (
                            ...
                            value: function() {
                                return l.default.createElement(
                                    ...
                                    l.default.createElement(
                                        ...
                                        {
                                            className:
                                                'hemingway-richtext-toolbar-inner-container ' +
                                                (this.props.showURLInput ? 'hemingway-show-url-input' : '')
                                        },
        ...
        var u = (function() {
            ...
            h = (function(e) {
                function t(e) {
                    ...
                    var n = i(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e));
                    return (
                        (n.onHover = n.onHover.bind(n)),
                        (n.onBlur = n.onBlur.bind(n)),
                        (n.replaceString = n.replaceString.bind(n)),
                        (n.state = f),
                        (n.timer = void 0),
                        n
                    );
                            ...
                            value: function(e) {
                                var t = this,
                                    ...
                                    r =
                                        ...
                                        (this.state.word !== e.options.word ||
                                            this.state.blockKey !== e.options.blockKey);
                                n
                                    ? (this.timer = window.setTimeout(function() {
                                          return t.setState(e.options);
                                      }, 500))
                                    : r
                                    ? (this.resetTimer(), this.setState(e.options))
                                    : this.setState(e.options);
                            }
                        },
                        {
                            key: 'onHover',
                                ...
                                return u
                                    ? l.default.createElement(
                                          ...
                                          l.default.createElement(
                                              'h4',
                                              null,
                                              l.default.createElement('em', null, s),
                                              ': ',
                                              n
                                          ),
                                          l.default.createElement(
    ...
    function(e, t, n) {
        ...
        var r = n(4),
            ...
            a = (0, r.over)(
                (0, r.lensProp)('editMode'),
                (0, r.ifElse)((0, r.equals)('edit'), (0, r.always)('write'), (0, r.always)('edit'))
            ),
            u = {
    ...
    function(e, t, n) {
        ...
        function o() {
            for (var e = void 0; void 0 === e || Object.prototype.hasOwnProperty.call(p, e) || !isNaN(+e); )
                e = Math.floor(Math.random() * h).toString(32);
            return (p[e] = !0), e;
        }
        function i() {
    ...
    function(e, t, n) {
        ...
        function i(e, t) {
            var n = t.options,
                ...
                a = n.event,
                u =
                    i === s.default.tokens.adverb ||
                    i === s.default.tokens.qualifier ||
                    i === s.default.tokens.vaguePhrase ||
                    i === s.default.tokens.passiveVoice ||
                    i === s.default.tokens.complexWord;
            if (u) {
                var l = o(a),
                    d = (0, c.default)(r, i),
                    ...
                    i(
                        ...
                        [
                            ...
                            },
                            {
                                ...
                                value: function(e, t) {
                                    return (
                                        t.highlights.forEach(function(t) {
                                            var n = t.startIndex,
                                                r = t.endIndex,
                                                o = t.style,
                                                i =
                                                    !!Object.prototype.hasOwnProperty.call(t, 'trailingSpace') &&
                                                    t.trailingSpace,
                                                a = o + '-' + i.toString();
                                            e.fill(a, n, r + 1);
                                        }),
        ...
        var o = n(4),
            ...
            g = {
                ...
                addHighlightsToSentence: function(e) {
                    var t = i.default.ifElse(
                        p,
                        this.getSimpleSentenceHighlights.bind(this),
                        this.getComplexSentenceHighlights.bind(this)
                    );
                    return i.default.pipe(
                        t,
                        y(e, 'highlights')
                    )(e);
                },
                ...
                getComplexSentenceHighlights: function(e) {
                    ...
                    return (
                        r && n.push(r),
                        e.tokens.reduce(function(n, r, o, i) {
        ...
        var o = n(60),
            ...
            y = {
                ...
                buildTree: function(e) {
                    ...
                    return (
                        'word' !== e.type &&
                            ((e.items = this.buildItems(e)),
                            e.items.forEach(function(e) {
                                t.buildTree(e);
                            }),
                            'sentence' === e.type && (e.tokens = this.getTokens(e) || [])),
                        e
                    );
                },
                ...
                fixBadSentenceSplit: function(e, t, n, r) {
                    var o = e,
                        i =
                            'Mr|Ms|Mrs|Dr|U\\.S|Col|Sgt|Lt|Adm|Maj|Sen|Rep|Jan|Feb|Apr|Mar|Jun|Jul|Aug|Sep|Sept|Oct|Nov|Dec|Pvt|Cpl|Capt|Gen|Ave|St|inc|ft|Gov|Jr|Sr|ltd|Rev|M|Mme|Prof|Pres|Hon|etc|vs|\\.\\.|e\\.g|i\\.e|a\\.m|p\\.m|[A-Z]',
                        a = new RegExp('\\b(' + i + ')$');
                ...
                getPassiveVoices: function(e) {
                    ...
                    return n
                        ? n
                              ...
                              .map(function(n, r, o) {
                                  return t.buildTreeFragment(
                                      p.default.tokens.passiveVoice,
                                      n,
                                      t.getPassiveIndex(e, n, r, o)
                                  );
                              })
                              .map(function(n) {
                                  return t.addTrailingSpaceSetting(n, e);
                ...
                findStringsInSentence: function(e, t, n) {
                    var r = this;
                    if (e.text.length > h) return [];
                    for (var o = [], i = /\b[\w'-]+\b/gi, a = [], u = void 0; (u = i.exec(e.text)); )
                        a.push({
                            text: u[0],
                    ...
                    return (
                        a.forEach(function(i, u) {
                            var s = i.text,
                                ...
                                c = [s];
                            a[u + 1] &&
                                a[u + 1].sentenceIndex === l + s.length + 1 &&
                                (c.push(s + ' ' + a[u + 1].text),
                                a[u + 2] &&
                                    a[u + 2].sentenceIndex === l + 1 + c[1].length &&
                                    (c.push(c[1] + ' ' + a[u + 2].text),
                                    a[u + 3] &&
                                        a[u + 3].sentenceIndex === l + 1 + c[2].length &&
                                        c.push(c[2] + ' ' + a[u + 3].text))),
                ...
                sumStats: function(e) {
                    return e.reduce(function(e, t) {
                        ...
                        return (
                            ...
                            (e.paragraphs += s),
                            (e.readingSeconds += l),
                            (e.readingLevel = u.default.getReadingLevel(e.letters, e.words, e.sentences)),
                            (e.readability = u.default.getReadabilityStyle({
                                words: e.words,
                                readingLevel: e.readingLevel
                            })),
                            (e.highlights.adverbs += d),
                            (e.highlights.passiveVoices += f),
                            (e.highlights.complexWords += p),
                            (e.highlights.hardSentences += h),
                            (e.highlights.veryHardSentences += y),
                            e
                        );
                    }, (0, i.default)());
                },
                    ...
                    r = (function(r) {
                        ...
                        return (
                            ...
                            (u.prototype.updateStatePropsIfNeeded = function() {
                                ...
                                return (
                                    (!this.stateProps || !(0, y.default)(e, this.stateProps)) &&
                                    ((this.stateProps = e), !0)
                                );
                            }),
                            (u.prototype.updateDispatchPropsIfNeeded = function() {
                                ...
                                return (
                                    (!this.dispatchProps || !(0, y.default)(e, this.dispatchProps)) &&
                            ...
                            (u.prototype.updateMergedPropsIfNeeded = function() {
                                ...
                                return (
                                    !(this.mergedProps && M && (0, y.default)(e, this.mergedProps)) &&
                                ...
                                if (this.unsubscribe) {
                                    ...
                                    if (!b || t !== e) {
                                        if (b && !this.doStatePropsDependOnOwnProps) {
                                            ...
                                            if (!n) return;
                                            n === E && (this.statePropsPrecalculationError = E.value),
                            ...
                            (u.prototype.render = function() {
                                ...
                                var f = !0;
                                return (
                                    (f = !!(s || l || t) && this.updateMergedPropsIfNeeded()),
                                    !f && i
                                        ? i
                                        : (S
                                              ...
                                              : (this.renderedElement = (0, d.createElement)(e, this.mergedProps)),
            ...
            return function(e) {
                return function(n, r, o) {
                    ...
                    return (
                        ...
                        (s = u.default.apply(void 0, l)(a.dispatch)),
                        i({}, a, {
                            dispatch: s
                        })
                    );
